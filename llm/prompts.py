...
# Backward-compatible names used by the package export surface.
SUMMARIZATION_SYSTEM_PROMPT = SYSTEM_PROMPT
SUMMARIZATION_USER_PROMPT_TEMPLATE = SUMMARY_PROMPT
QNA_SYSTEM_PROMPT = SYSTEM_PROMPT
QNA_USER_PROMPT_TEMPLATE = QNA_PROMPT